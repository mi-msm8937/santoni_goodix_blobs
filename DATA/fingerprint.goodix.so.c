...
void FUN_0010805c(void)

{
  int iVar1;
  
  DAT_0014e344 = false;
  iVar1 = pthread_key_create(&DAT_0014e340,(__destr_function *)&LAB_001107b4);
  DAT_0014e344 = iVar1 == 0;
  __cxa_atexit(&LAB_00110798,&DAT_0014e340,&DAT_0013c000);
  return;
}
...
undefined8 FUN_0010812c(longlong param_1)
...
undefined8 FUN_00108168(undefined8 param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  if (param_3 == (undefined8 *)0x0) {
    ...
    *__s = 0x48574454;
    __s[1] = 0x200;
    *(undefined8 *)(__s + 0x1c) = 0x108c54;
    *(undefined8 *)(__s + 0x22) = 0x108bc4;
    *(undefined8 *)(__s + 0x26) = 0x10812c;
    *(undefined8 *)(__s + 0x24) = 0x108a54;
    *(undefined8 *)(__s + 0x76) = 0xdeadbeef;
    *(undefined8 *)(__s + 0x28) = 0x1080ec;
    local_18 = 0;
    *(undefined8 *)(__s + 0x30) = 0x1089ec;
    local_10 = 0;
    *(undefined8 *)(__s + 0x32) = 0x10885c;
    *(undefined8 *)(__s + 0x2a) = 0x108780;
    *(undefined8 *)(__s + 0x2c) = 0x108534;
    *(undefined8 *)(__s + 0x2e) = 0x1084a8;
    *(undefined8 *)(__s + 0x20) = 0x10842c;
    *(undefined8 *)(__s + 0x34) = 0x10839c;
    local_68 = 0;
    uStack96 = 0;
    local_58 = 0;
    uStack80 = 0;
...
undefined8
FUN_0010839c(undefined8 param_1,uint param_2,uint param_3,uint param_4,undefined8 param_5,
            ulonglong param_6)
...
undefined8 FUN_0010842c(longlong param_1,undefined8 param_2)
...
ulonglong FUN_001084a8(undefined8 param_1,ulonglong param_2,ulonglong param_3)
...
ulonglong FUN_00108534(undefined8 param_1)

{
  ...
  if (DAT_0013c168 == 0) {
    uVar2 = gf_worker_thread_create(&DAT_0013c168);
    if ((int)uVar2 != 0) {
      puts("creat worker threat fail");
      return uVar2 & 0xffffffff;
    }
  }
  uVar1 = gf_send_callback_msg(DAT_0013c168,param_1,FUN_00108604);
  if (uVar1 != 0) {
...
undefined8 FUN_00108604(longlong param_1)

{
  ...
  if (param_1 == 0) {
    ...
    local_8c = 0x28;
    uVar1 = goodix_sensor_fp_enumerate(local_88,&local_8c);
    uVar2 = __android_log_print(3,"FingerGoodix","%s:ret=%d,array_size= %d",
                                "enumerate_callback_func",uVar1 & 0xffffffff,(ulonglong)local_8c);
    if ((((int)(uVar1 & 0xffffffff) == 0) && (local_8c != 0)) && (local_8c >> 3 != 0)) {
      uVar4 = (local_8c >> 3) - 1;
      puVar3 = local_88 + 1;
      do {
        local_50 = local_50 & 0xffffffff00000000 | (ulonglong)uVar4;
        local_58 = CONCAT44(*puVar3,puVar3[-1]);
        local_60 = CONCAT44(local_60._4_4_,6);
        (**(code **)(param_1 + 0x78))(&local_60);
        uVar1 = (ulonglong)uVar4;
        uVar4 = uVar4 - 1;
        uVar2 = __android_log_print(3,"FingerGoodix","%s:remaining_templats=%d,fid=%d,gid=%d",
                                    "enumerate_callback_func",uVar1,(ulonglong)*puVar3,
                                    (ulonglong)puVar3[-1]);
        puVar3 = puVar3 + 2;
...
undefined8 FUN_00108780(longlong param_1)
...
undefined8 FUN_0010885c(longlong param_1,undefined8 param_2,ulonglong param_3)
...
void FUN_00108cac(longlong param_1,byte *param_2,uint param_3)
...
LAB_00108f04:
    ...
    if (iVar10 == 2) goto LAB_00108ef8;
    uVar6 = (ulonglong)param_2[2];
    if (iVar10 == 3) goto LAB_00108efc;
    uVar7 = (ulonglong)param_2[3];
    if (iVar10 == 4) goto LAB_00108f00;
    uVar8 = (ulonglong)param_2[4];
    if (iVar10 == 5) goto LAB_00108f04;
    bVar3 = param_2[5];
    uVar4 = (uint)bVar3;
...
void FUN_00108f3c(longlong param_1,uint param_2)
  ...
  if (param_2 == 0) {
    ...
    if (uVar3 < param_2) {
      if (*(int *)(lVar2 + 0x13c) != 0) {
        ...
        uVar3 = uVar3 + 1;
        if (param_2 <= uVar3) goto LAB_00109120;
      }
...
{
  if (DAT_0013c1b0 != 0) {
    return (ulonglong)*(uint *)(DAT_0013c1b0 + 0x1b0);
  }
  return 0;
}
...

{
  ...
  uVar1 = pthread_create((pthread_t *)((longlong)param_1 + 0xf8),(pthread_attr_t *)0x0,
                         (__start_routine *)&LAB_00109554,param_1);
...
LAB_0010ad10:
          ...
          send_fp_removed(0xffffffff,uVar7,uVar7,uVar9,uVar5);
          goto LAB_0010ae14;
        }
        if (param_1 == 0x10c) {
          uVar5 = 1;
...

{
  ...
  if (plVar2 == (longlong *)0x0) {
    ...
    __android_log_print(6,"FingerGoodix","fpcode, sGxFpDevice->getFp(), return NULL!");
LAB_0010c164:
    if (plVar2 == (longlong *)0x0) goto LAB_0010c0ec;
  }
  else {
    if (DAT_0013c10c != 0) {
      local_10 = plVar2;
...

{
  ...
  if (plVar2 == (longlong *)0x0) {
    ...
    __android_log_print(6,"FingerGoodix","fpcode, sGxFpDevice->getFp(), return NULL!");
LAB_0010c4d0:
    if (plVar2 == (longlong *)0x0) goto LAB_0010c454;
  }
  else {
    if (DAT_0013c10c != 0) {
      local_10 = plVar2;
    ...
    if (plVar3 == (longlong *)0x0) {
      ...
      if (DAT_0013c10c == 0) {
        ...
        if ((param_2 == 0) && (param_3 == 0)) {
          ...
          if ((int)uVar4 == 0) {
            do {
              if (0 < (int)*puVar6) {
                ...
                (**(code **)*sGxFpDevice)(sGxFpDevice,0x1004,0,(ulonglong)*puVar6);
              }
              puVar6 = puVar6 + 1;
          ...
          (**(code **)*sGxFpDevice)(sGxFpDevice,0x1004,0,(ulonglong)param_2);
        }
        uVar5 = 0;
        (**(code **)*sGxFpDevice)(sGxFpDevice,0x1001,0,0);
        if (plVar3 == (longlong *)0x0) goto LAB_0010c9fc;
      }
      decStrong((void *)((longlong)plVar3 + *(longlong *)(*plVar3 + -0x18)));
    }
  }
    ...
    if (plVar3 != (longlong *)0x0) {
      if (param_1 < 0xb) {
        ...
        if (param_1 - 1 < 7) {
          ...
          case 2:
            if (param_2 - 1 < 3) {
              DAT_0013c110 = *(undefined4 *)(&DAT_001234a0 + (ulonglong)(param_2 - 1) * 4);
            }
            else {
        ...
        if (plVar3 == (longlong *)0x0) goto LAB_0010cb5c;
      }
      else {
        uVar4 = 0xfffffffe;
      }
...

{
  ...
  if (plVar4 == (longlong *)0x0) {
    ...
    __android_log_print(6,"FingerGoodix","fpcode, sGxFpDevice->getFp(), return NULL!");
LAB_0010ce68:
    if (plVar4 == (longlong *)0x0) goto LAB_0010ce10;
  }
  else {
    uVar5 = 0xfffffffd;
    if (DAT_0013c10c != 0) {
...

{
  ...
  if (param_2 == 8) {
    ...
    if (param_2 == 9) {
      ...
      DAT_0013c584 = 0xfffffffe;
      uVar1 = gx_gfCmdM((int)*(undefined8 *)(ulonglong)(byte)param_1,(uchar *)0x97,
                        (int)register0x00000008 + -0x98,(uchar *)0x4,0x13c380,(int *)0x208);
      __android_log_print(3,"FingerGoodix","SendCmd ret:%d, cmd:%d, command execute status:%d",
                          uVar1 & 0xffffffff,uVar3,(ulonglong)DAT_0013c584);
      if (DAT_0013c584 == 0) {
        __android_log_print(3,"FingerGoodix","fido_uvt_len:%d",(ulonglong)DAT_0013c380);
        send_fp_gx_cmd_exed(uVar3,0,0,&DAT_0013c384,(longlong)(int)DAT_0013c380);
        uVar4 = 1;
        goto LAB_0010cf20;
      }
      uVar4 = 1;
  ...
  send_fp_gx_cmd_exed(uVar3,(ulonglong)(uint)param_3,(ulonglong)(uint)param_4,&DAT_0013c378,4);
LAB_0010cf20:
  if (local_8 == __stack_chk_guard) {
    return uVar4;
  }
...

{
  ...
  local_8 = __stack_chk_guard;
  __android_log_print(3,"FingerGoodix","gCheckFingerprintidsConsistence:%d",(ulonglong)DAT_0013c590)
  ;
  if (DAT_0013c590 != 1) {
...

{
  ...
  if (iVar1 != -1) {
    ...
    if (gCheckFingerprintidsConsistence_flag == 1) {
      DAT_0013c590 = gCheckFingerprintidsConsistence_flag;
    }
...
undefined8 FUN_0010e81c(int *param_1)
  ...
  if (__ptr == (undefined4 *)0x0) {
    ...
    *__ptr = 0x574f524b;
    ...
    if ((int)uVar2 < 0) {
      ...
      uVar1 = pthread_create((pthread_t *)&local_10,(pthread_attr_t *)0x0,FUN_0010e81c,__ptr);
...

{
  ...
  *puVar1 = 0x13a7b0;
                    // WARNING: Subroutine does not return
  __cxa_throw(puVar1,&PTR_PTR____si_class_type_info_0013b6d0,&LAB_0010ee70);
}
...

{
  ...
  *puVar1 = 0x13a7e0;
                    // WARNING: Subroutine does not return
  __cxa_throw(puVar1,&PTR_PTR____si_class_type_info_0013b6e8,&LAB_0010ee80);
}
...
LAB_0010ef74:
  ...
  if (iVar2 == 0) {
    if (param_1 + 0x80U < 0x401) {
      ...
      do {
        if ((uVar3 & 1) == 0) {
          uVar3 = 1 << (uVar5 & 0x3f) | DAT_0014e330;
          puVar4 = &DAT_0013e330 + uVar5 * 0x80;
          DAT_0014e330 = uVar3;
...
void FUN_0010f044(undefined8 param_1,longlong param_2)
...

{
  ...
  if (iVar1 == 0) {
    puVar2 = DAT_0014e330;
    DAT_0014e330 = (undefined8 *)
                   ((ulonglong)DAT_0014e330 &
                   (1 << ((ulonglong)(param_1 + -0x27c66) >> 10 & 0x3f) ^ 0xffffffffffffffffU));
...
LAB_0010f130:
  ...
  if (iVar2 == 0) {
    ...
    DAT_0013c6f0 = 1 << (param_2 & 0x3f) | DAT_0013c6f0;
    puVar4 = &DAT_0013c700 + param_2 * 0xe;
    iVar2 = pthread_mutex_unlock((pthread_mutex_t *)&DAT_0013e300);
...

{
  ...
  if (iVar1 == 0) {
    pcVar2 = DAT_0013c6f0;
    DAT_0013c6f0 = (code *)((ulonglong)DAT_0013c6f0 &
                           (1 << (SUB168(ZEXT416((int)param_1 - 0x13c700U >> 4) *
...
void FUN_0010f3a4(byte *param_1,ulonglong *param_2)
...
ulonglong * FUN_0010f3e4(byte param_1,ulonglong *param_2,ulonglong *param_3,ulonglong *param_4)

{
  ...
  if (param_1 != 0x50) {
    ...
    default:
      ...
      abort();
    case 9:
      puVar3 = (ulonglong *)FUN_0010f3a4(param_3,&local_8);
      break;
    case 10:
      puVar3 = (ulonglong *)((longlong)param_3 + 2);
...
void FUN_0010f570(longlong param_1,byte *param_2,undefined8 *param_3)
  ...
  *param_3 = uVar3;
  ...
  if (bVar1 == 0xff) {
    ...
    *(byte *)(param_3 + 5) = bVar1;
    ...
    uVar3 = FUN_0010f4f4((ulonglong)bVar1,param_1);
    pbVar5 = (byte *)FUN_0010f3e4((ulonglong)bVar1,uVar3,param_2 + 1,param_3 + 1);
    pbVar4 = pbVar5 + 1;
    bVar1 = *pbVar5;
    *(byte *)(param_3 + 5) = bVar1;
  }
...
ulonglong FUN_0010f67c(longlong param_1,longlong *param_2,longlong **param_3,ulonglong param_4)

{
  ...
  do {
    ...
    FUN_0010f3e4((ulonglong)bVar1,*(undefined8 *)(param_1 + 0x10),
...

{
  ...
  if ((param_2 == 6) <= bVar1) {
    ...
    local_58 = (byte *)FUN_0010f570(param_5,local_60,&local_30);
    local_20 = FUN_0010f4f4((ulonglong)local_8,param_5);
    ...
    if (local_58 < local_10) {
      ...
      do {
        ...
        local_58 = pbVar9;
        uVar13 = FUN_0010f4f4(uVar5,0);
        local_58 = (byte *)FUN_0010f3e4(uVar5,uVar13,local_58,&local_48);
        uVar5 = (ulonglong)local_7;
        uVar13 = FUN_0010f4f4(uVar5,0);
        local_58 = (byte *)FUN_0010f3e4(uVar5,uVar13,local_58,&local_40);
        uVar5 = (ulonglong)local_7;
        uVar13 = FUN_0010f4f4(uVar5,0);
        pbVar9 = (byte *)FUN_0010f3e4(uVar5,uVar13,local_58,&local_38);
        uVar10 = 0;
        uVar5 = 0;
        do {
          pbVar9 = pbVar9 + 1;
...
LAB_0010f8c0:
    if (local_48 < 0) {
      ...
      local_20 = FUN_0010f4f4((ulonglong)local_8,param_5);
      uVar5 = FUN_0010f4f4((ulonglong)local_8,param_5);
      param_4[-2] = uVar5;
    }
    goto LAB_0010f864;
  }
  goto LAB_0010f860;
LAB_0010fb14:
  local_58 = (byte *)FUN_0010f3a4(local_10,&local_48);
  FUN_0010f3a4(local_58,&local_40);
  ...
  if (uVar5 == 0) {
    ...
    if ((longlong)uVar5 < 1) {
      if (bVar1 < (local_70 != (undefined **)0x0 && local_78 == 0)) {
        uVar4 = FUN_0010f67c(&local_30,local_70,local_68);
        uVar4 = uVar4 & 0xff ^ 1;
      }
      else {
        uVar11 = 0;
...
LAB_0010fc78:
      ...
      if (local_8 != 0xff) {
        if (((uint)local_8 & 7) < 5) {
                    // WARNING: Could not recover jumptable at 0x0010fbe8. Too many branches
                    // WARNING: Treating indirect jump as call
          uVar13 = (*(code *)(&UNK_0010fbec + (longlong)(char)local_80[(uint)local_8 & 7] * 4))();
          return uVar13;
        }
                    // WARNING: Subroutine does not return
        abort();
      }
      FUN_0010f3e4((ulonglong)local_8,local_20,local_18,&local_38);
      if (local_38 == (ulonglong **)0x0) goto LAB_0010fc78;
...
LAB_0010f860:
  if (local_48 < 0) {
    ...
    pFVar12 = *(FuncDef38 **)(lVar6 + -0x38);
    __unexpected(*(FuncDef40 **)(lVar6 + -0x40));
    __cxa_begin_catch();
    ...
    FUN_0010f570(0,uVar13,auStack288);
    uVar4 = FUN_0010f67c(auStack288,puVar14[-0xe],puVar14,(longlong)iVar3);
    if ((uVar4 & 0xff) == 0) {
      uVar4 = FUN_0010f67c(auStack288,&typeinfo,0,(longlong)iVar3);
      if ((uVar4 & 0xff) == 0) {
                    // WARNING: Subroutine does not return
        __terminate(pFVar12);
      }
...

{
  ...
  pFVar5 = *(FuncDef38 **)(param_1 + -0x38);
  __unexpected(*(FuncDef40 **)(param_1 + -0x40));
  __cxa_begin_catch();
  ...
  FUN_0010f570(0,uVar6,auStack48);
  uVar2 = FUN_0010f67c(auStack48,puVar7[-0xe],puVar7,(longlong)iVar1);
  if ((uVar2 & 0xff) != 0) {
    uVar6 = __cxa_rethrow();
    __cxa_end_catch();
    __cxa_end_catch();
  ...
  uVar2 = FUN_0010f67c(auStack48,&typeinfo,0,(longlong)iVar1);
  if ((uVar2 & 0xff) != 0) {
...
void __terminate(FuncDef38 *param_1)
...
undefined * set_terminate(FuncDef39 *param_1)
...

{
  ...
  pFVar1 = (FuncDef38 *)get_terminate();
                    // WARNING: Subroutine does not return
  __terminate(pFVar1);
}
...
void __unexpected(FuncDef40 *param_1)
...
undefined * set_unexpected(FuncDef41 *param_1)
...

{
  ...
  pFVar5 = (FuncDef40 *)get_unexpected();
  uVar4 = __unexpected(pFVar5);
  if (1 < uVar4) {
                    // WARNING: Subroutine does not return
    __terminate(*(FuncDef38 **)(in_x1 + -0x38));
  }
...

{
  ...
  *(undefined8 *)(param_1 + -0x18) = 0x10feac;
...
FuncDef42 * set_new_handler(FuncDef42 *param_1)
...
// WARNING: Removing unreachable block (ram,0x00110154)
...
ulonglong FUN_001102dc(longlong param_1,longlong param_2)
...

{
  ...
  pvVar1 = pthread_getspecific(DAT_0014e340);
...
longlong FUN_00110a5c(longlong param_1,undefined4 param_2,longlong param_3,longlong param_4)
...
longlong FUN_00110afc(longlong param_1,longlong param_2,int param_3)
...
int ** FUN_00110b5c(longlong param_1,int **param_2,int param_3)

{
  ...
  do {
    if ((cVar2 == 'V') || (cVar2 == 'r')) {
      ...
      *(int *)(param_1 + 0x50) = *(int *)(param_1 + 0x50) + 9;
      piVar4 = (int *)FUN_00110a5c(param_1,(ulonglong)uVar5,0,0);
      *ppiVar6 = piVar4;
    }
    else {
      if (cVar2 != 'K') {
...
longlong FUN_00110d0c(longlong param_1,int param_2)
  ...
  if (pcVar7[1] != '\0') {
    *(char **)(param_1 + 0x18) = pcVar7 + 2;
    ...
    if (((uVar14 & 0xff) < 10) || (bVar5 == 0x5f)) {
      ...
      if (0x19 < (byte)(bVar5 + 0xbf)) goto LAB_00110dd8;
    }
    uVar10 = 0;
    do {
      iVar6 = (int)uVar8;
      ...
      if (*pbVar12 != 0) {
        *(byte **)(param_1 + 0x18) = pbVar12 + 1;
        ...
        if (*pbVar12 == 0x5f) goto LAB_00110e44;
      }
...
longlong FUN_00111110(byte **param_1)
...
longlong FUN_00111198(longlong param_1,ulonglong *param_2)
    ...
    if ((piVar3 != (int *)0x0) && (*piVar3 == 0x2f)) {
      ...
      if (iVar4 < 1) {
        ...
        do {
          ...
          uVar1 = (int)uVar2 - 1;
          uVar2 = (ulonglong)uVar1;
          if ((piVar3 == (int *)0x0) || (*piVar3 != 0x2f)) goto LAB_001111e8;
        } while (uVar1 != 0);
      }
  ...
  if (param_2 != (undefined4 *)0x0) {
    do {
      ...
      case 0x4b:
        goto LAB_00111260;
      case 5:
        piVar2 = (int *)FUN_00111198(param_1,param_2 + 2);
      ...
      lVar1 = FUN_00111214(param_1,*(undefined8 *)(param_2 + 2));
      if (lVar1 != 0) {
        return (int *)lVar1;
      }
...
void FUN_001112ac(void *param_1,longlong param_2,void **param_3)
...
longlong FUN_00111450(longlong param_1,int param_2)
    ...
    *(longlong *)(param_1 + 0x18) = (longlong)__s1 + lVar4;
    ...
    if ((((9 < param_2) && (iVar2 = memcmp(__s1,"_GLOBAL_",8), iVar2 == 0)) &&
      ...
      *(int *)(param_1 + 0x50) = (*(int *)(param_1 + 0x50) + 0x16) - param_2;
      uVar3 = FUN_00110afc(param_1,"(anonymous namespace)",0x15);
      return uVar3;
    }
    iVar2 = *(int *)(param_1 + 0x28);
    if (iVar2 < *(int *)(param_1 + 0x2c)) {
...
undefined8 FUN_00111670(longlong param_1)
...
longlong FUN_00111718(longlong param_1)
...
ulonglong FUN_001117a4(longlong param_1)
...
longlong FUN_00111848(longlong param_1)
...
undefined8 FUN_00111934(longlong param_1,uint param_2)
...
longlong FUN_00111a20(longlong param_1)
  ...
  *(char **)(param_1 + 0x18) = pcVar15;
  ...
  if (cVar3 == 'E') {
    *(char **)(param_1 + 0x18) = __s1 + 2;
    uVar12 = FUN_00110a5c(param_1,0x2f,0,0);
    return uVar12;
  }
  plVar11 = &local_8;
  local_8 = 0;
        ...
        if (cVar3 == 's') {
          if (pcVar15[2] == 'r') {
            *(char **)(param_1 + 0x18) = pcVar15 + 3;
            ...
            if (pcVar15[2] != 'p') goto LAB_00111b7c;
            *(char **)(param_1 + 0x18) = pcVar15 + 3;
...
switchD_00111dbc_caseD_3:
                    ...
                    if (iVar4 == 0) {
                      ...
                      cVar3 = *__s1;
                      if (cVar3 == 'L') {
                        piVar14 = (int *)FUN_00116200(param_1);
                        __s1 = *(char **)(param_1 + 0x18);
                        cVar3 = *__s1;
LAB_00112218:
                        if (cVar3 == 'L') {
...
LAB_00112270:
                                  piVar10 = (int *)FUN_00114e18(param_1);
                                  if (piVar10 == (int *)0x0) {
LAB_001126d0:
                                    lVar5 = 0;
                                  }
                                    ...
                                    if (iVar4 == 0x31) {
                                      ...
                                      *(int *)(param_1 + 0x50) =
                                      ...
                                      if (iVar4 != 0) {
                                        ...
                                        case 0:
                                          goto switchD_001126cc_caseD_0;
                                        default:
                                          goto switchD_001126cc_caseD_4;
                                        case 1:
                                      ...
                                      if (iVar4 == 0x32) {
                                        ...
                                        switch(piVar10[2]) {
                                        case 0:
switchD_001126cc_caseD_0:
                                          lVar5 = FUN_00110a5c(param_1,0x35,piVar10,0);
                                          break;
                                        case 2:
                                          __s1 = (char *)0x0;
switchD_001126cc_caseD_2:
                                          if ((**(char ***)(piVar10 + 2))[1] == 'c') {
                                            ...
                                            goto LAB_00112988;
                                            local_20 = FUN_00113660(param_1,(ulonglong)bVar2,__s1,0)
                                            ;
                                          }
                                          else {
LAB_00112988:
                                          ...
                                          lVar5 = FUN_00110a5c(param_1,0x37,piVar10,uVar7);
                                          break;
                                        case 3:
                                          __s1 = (char *)0x0;
...
LAB_00112ac0:
                                          ...
                                          lVar5 = FUN_00110a5c(param_1,0x39,piVar10,uVar7);
                                          break;
                                        case 1:
...
LAB_001122b8:
                                    lVar5 = FUN_00110a5c(param_1,0x36,piVar10,uVar7);
                                  }
                                }
                              }
                              else {
                        ...
                        if (cVar3 == 'T') {
                          piVar14 = (int *)FUN_00111848(param_1);
                          __s1 = *(char **)(param_1 + 0x18);
                          cVar3 = *__s1;
                          goto LAB_00112218;
                        }
                        if (cVar3 == 's') {
                          if (__s1[1] == 'r') {
                            *(char **)(param_1 + 0x18) = __s1 + 2;
                            piVar14 = (int *)FUN_00113660(param_1);
                            uVar7 = FUN_0011500c(param_1);
                            if (**(char **)(param_1 + 0x18) != 'I') {
                              piVar14 = (int *)FUN_00110a5c(param_1,1,piVar14,uVar7);
                              __s1 = *(char **)(param_1 + 0x18);
                              cVar3 = *__s1;
                              goto LAB_00112218;
                            }
                          ...
                          if (__s1[1] != 'p') goto LAB_001121b4;
                          *(char **)(param_1 + 0x18) = __s1 + 2;
                          piVar14 = (int *)FUN_00116378(param_1);
                          uVar7 = 0x4a;
LAB_00112558:
                          piVar14 = (int *)FUN_00110a5c(param_1,uVar7,piVar14,0);
LAB_00112564:
                          __s1 = *(char **)(param_1 + 0x18);
LAB_00112568:
                          cVar3 = *__s1;
...
LAB_00112574:
                          ...
                          if (iVar4 < *(int *)(param_1 + 0x2c)) {
                            *(int *)(param_1 + 0x28) = iVar4 + 1;
                            ...
                            if (piVar14 == (int *)0x0) goto LAB_00112568;
                        ...
                        if ((byte)(cVar3 - 0x30U) < 10) {
LAB_001123cc:
                          piVar14 = (int *)FUN_0011500c(param_1);
                          __s1 = *(char **)(param_1 + 0x18);
                          cVar3 = *__s1;
                        ...
                        if (cVar3 == 'o') {
                          ...
                          if (((cVar3 == 't') || (cVar3 == 'i')) && (__s1[1] == 'l')) {
                            ...
                            *(char **)(param_1 + 0x18) = __s1 + 2;
                            uVar8 = FUN_00112f0c(param_1,0x45);
                            piVar14 = (int *)FUN_00110a5c(param_1,0x30,uVar7,uVar8);
                            __s1 = *(char **)(param_1 + 0x18);
                            cVar3 = *__s1;
                            goto LAB_00112218;
                          }
...
LAB_001121b4:
                        piVar14 = (int *)FUN_00114e18(param_1);
                        if (piVar14 == (int *)0x0) goto LAB_00112564;
                        iVar4 = *piVar14;
                        if (iVar4 == 0x31) {
                          ...
                          *(int *)(param_1 + 0x50) =
                          ...
                          if (iVar4 != 0) {
                            ...
                            default:
                              goto switchD_00112750_caseD_4;
                            case 2:
                              goto switchD_00112750_caseD_2;
                            case 0:
                              goto switchD_00112750_caseD_0;
                            case 1:
...
switchD_00112750_caseD_4:
                          __s1 = *(char **)(param_1 + 0x18);
                          goto LAB_00112574;
                        }
                        switch(piVar14[2]) {
                        case 0:
switchD_00112750_caseD_0:
                          uVar7 = 0x35;
                          goto LAB_00112558;
                        case 2:
                          __s1 = (char *)0x0;
...
switchD_001126cc_caseD_4:
                    uVar7 = FUN_00110a5c(param_1,0x3b,piVar14,lVar5);
...
LAB_001121fc:
  uVar8 = 0x36;
LAB_00112204:
  piVar14 = (int *)FUN_00110a5c(param_1,uVar8,piVar14,uVar7);
  __s1 = *(char **)(param_1 + 0x18);
  cVar3 = *__s1;
  goto LAB_00112218;
switchD_001126cc_caseD_1:
  ...
  if (((cVar3 == 'm') || (cVar3 == 'p')) && (__s1[1] == cVar3)) {
    ...
    if (bVar2 != 0x5f) {
      uVar7 = FUN_00116378(param_1,(ulonglong)bVar2,__s1,0);
      uVar7 = FUN_00110a5c(param_1,0x38,uVar7,uVar7);
      goto LAB_001122b8;
    }
...
longlong FUN_00112f0c(longlong param_1,char param_2)
        ...
        *(char **)(param_1 + 0x18) = __s1 + 2;
        if (__s1[2] == 'T') {
          ...
          *(char **)(param_1 + 0x18) = __s1 + 3;
          ...
          if (iVar3 + 1 == 0) goto switchD_0011328c_caseD_4;
          lVar7 = (longlong)(iVar3 + 1);
        }
        iVar3 = *(int *)(param_1 + 0x28);
        if (*(int *)(param_1 + 0x2c) <= iVar3) goto switchD_0011328c_caseD_4;
        *(int *)(param_1 + 0x28) = iVar3 + 1;
        lVar6 = *(longlong *)(param_1 + 0x20) + (longlong)iVar3 * 0x18;
        if (lVar6 == 0) goto switchD_0011328c_caseD_4;
...
LAB_00112fc0:
          ...
          if (piVar4 == (int *)0x0) goto switchD_0011328c_caseD_4;
          iVar3 = *piVar4;
          if (iVar3 == 0x31) {
                ...
                if (iVar3 == 0) {
                  ...
                  if (cVar2 == 'E') {
                    ...
                    *(char **)(param_1 + 0x18) = __s1 + 1;
                    ...
                    if (cVar2 == 'p') {
                      if (__s1[1] != 'i') goto switchD_0011328c_caseD_4;
                      *(char **)(param_1 + 0x18) = __s1 + 2;
                      uVar9 = FUN_00112f0c(param_1,0x45);
                    }
                    else {
                      if ((cVar2 != 'i') || (__s1[1] != 'l')) {
switchD_0011328c_caseD_4:
                        *(undefined4 *)(param_1 + 0x54) = uVar1;
                        return 0;
                      }
                      uVar9 = FUN_00116378(param_1);
            ...
            if (iVar3 != 0x33) goto switchD_0011328c_caseD_4;
            if (**(char **)(param_1 + 0x18) == '_') {
              *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
...
int * FUN_00113660(longlong param_1)
    ...
    *(byte **)(param_1 + 0x18) = pbVar21;
    if (pbVar22[1] == 0x5f) {
      ...
      if ((byte)(pbVar22[1] - 0x30) < 10) {
        ...
        lVar13 = FUN_00110afc(param_1,pbVar21,(ulonglong)(uint)((int)pbVar23 - (int)pbVar21));
joined_r0x00114138:
        if (lVar13 == 0) goto LAB_00113884;
...
LAB_00114134:
        ...
        if (bVar7 == 0x73) {
          if (pbVar22[2] == 0x72) {
            ...
            *(byte **)(param_1 + 0x18) = pbVar22 + 3;
            uVar16 = FUN_00116378(param_1);
            lVar13 = FUN_00110a5c(param_1,0x4a,uVar16,0);
          }
          goto LAB_00114134;
        }
        if (bVar7 != 0x66) {
...
LAB_001141ac:
            ...
            if (lVar13 != 0) {
              ...
              uVar16 = FUN_00111a20(param_1);
              lVar13 = FUN_00110a5c(param_1,4,lVar13,uVar16);
              goto LAB_00114134;
            }
          }
          else {
            if (bVar7 == 0x6f) {
              ...
              if (((bVar7 == 0x74) || (bVar7 == 0x69)) && (pbVar22[2] == 0x6c)) {
                ...
                *(longlong *)(param_1 + 0x18) = *(longlong *)(param_1 + 0x18) + 2;
                ...
                lVar13 = FUN_00110a5c(param_1,0x30,uVar16,uVar17);
                goto LAB_00114134;
              }
            }
LAB_001140d8:
              ...
              if (iVar10 == 0x31) {
                ...
                *(int *)(param_1 + 0x50) =
                ...
                if (iVar10 == 0) {
                  uVar16 = FUN_00113660(param_1);
LAB_00114120:
                  lVar13 = FUN_00110a5c(param_1,0x36,piVar12,uVar16);
                  goto LAB_00114134;
                }
                ...
                case 1:
                  ...
                  if (((cVar8 == 'm') || (cVar8 == 'p')) && (__s1[1] == cVar8)) {
                    if (**(char **)(param_1 + 0x18) != '_') {
                      uVar16 = FUN_00116378(param_1);
                      uVar16 = FUN_00110a5c(param_1,0x38,uVar16,uVar16);
                      goto LAB_00114120;
                    }
                    *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
                  }
                ...
                if (iVar10 == 0x32) {
                  switch(piVar12[2]) {
                  case 0:
switchD_0011469c_caseD_0:
                    lVar13 = FUN_00110a5c(param_1,0x35,piVar12,0);
                    goto LAB_00114134;
                  case 2:
                    __s1 = (char *)0x0;
switchD_0011469c_caseD_2:
                    ...
                    uVar16 = FUN_00110a5c(param_1,0x38,uVar16,uVar17);
                    lVar13 = FUN_00110a5c(param_1,0x37,piVar12,uVar16);
                    goto LAB_00114134;
                  case 3:
                    __s1 = (char *)0x0;
...
LAB_00114518:
                      ...
                      uVar16 = FUN_00110a5c(param_1,0x3a,uVar16,uVar17);
                      lVar13 = FUN_00110a5c(param_1,0x39,piVar12,uVar16);
                      goto LAB_00114134;
                    }
                    if ((*__s1 == 'n') && ((__s1[1] == 'a' || (__s1[1] == 'w')))) {
                      uVar16 = FUN_00112f0c(param_1,0x5f);
                  ...
                  if (iVar10 == 0x33) {
                    if (**(char **)(param_1 + 0x18) == '_') {
                      *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
                      uVar16 = FUN_00112f0c(param_1,0x45);
                      goto LAB_00114120;
                    }
        ...
        *(byte **)(param_1 + 0x18) = pbVar22 + 3;
        if (pbVar22[3] == 0x54) {
          ...
          *(byte **)(param_1 + 0x18) = pbVar22 + 4;
          ...
          iVar10 = iVar10 + 1;
          if (iVar10 == 0) goto switchD_0011469c_caseD_4;
        }
        iVar6 = *(int *)(param_1 + 0x28);
        if (*(int *)(param_1 + 0x2c) <= iVar6) goto switchD_0011469c_caseD_4;
        *(int *)(param_1 + 0x28) = iVar6 + 1;
        lVar13 = *(longlong *)(param_1 + 0x20) + (longlong)iVar6 * 0x18;
        if (lVar13 == 0) goto switchD_0011469c_caseD_4;
...
LAB_00113874:
    ...
    *(byte **)(param_1 + 0x18) = pbVar21 + 1;
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x2a,lVar13,uVar16);
    break;
  case 0x43:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x25,uVar16,0);
    break;
  case 0x44:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    if (pbVar22[1] == 0) {
    ...
    case 0x46:
      ...
      if (*(int *)(param_1 + 0x2c) <= iVar10) {
        uRam0000000000000000 = 0;
                    // WARNING: Could not recover jumptable at 0x00114194. Too many branches
                    // WARNING: Treating indirect jump as call
...
switchD_00114718_caseD_2:
                        if ((**(char ***)(piVar12 + 2))[1] == 'c') {
                          ...
                          uVar16 = FUN_00113660(param_1,(ulonglong)bVar7,0);
                        }
                        else {
LAB_00114960:
                          uVar16 = FUN_00116378(param_1);
...
switchD_00114718_caseD_4:
      *(undefined4 *)(param_1 + 0x54) = uVar2;
      local_8 = (int *)FUN_00110a5c(param_1,0x42,lVar13,0);
      if (local_8 == (int *)0x0) {
        return (int *)0;
      }
      __s1 = *(char **)(param_1 + 0x18);
      ...
      *(char **)(param_1 + 0x18) = __s1 + 1;
      ...
      goto LAB_001137c4;
    case 0x61:
      uVar16 = FUN_00110afc(param_1,&DAT_00124ab0,4);
      return (int *)uVar16;
    case 100:
      iVar10 = *(int *)(param_1 + 0x28);
    ...
    case 0x70:
      uVar16 = FUN_00113660(param_1);
      local_8 = (int *)FUN_00110a5c(param_1,0x4a,uVar16,0);
      goto LAB_001137c0;
    case 0x73:
      iVar10 = *(int *)(param_1 + 0x28);
      if (iVar10 < *(int *)(param_1 + 0x2c)) {
...
LAB_00114004:
    local_8 = (int *)0x0;
                    // WARNING: Could not recover jumptable at 0x00114010. Too many branches
                    // WARNING: Treating indirect jump as call
  ...
  case 0x47:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x26,uVar16,0);
    break;
  case 0x4d:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    lVar13 = FUN_00113660(param_1);
    if ((lVar13 == 0) || (lVar14 = FUN_00113660(param_1), lVar14 == 0)) {
LAB_00113884:
      local_8 = (int *)0x0;
    }
    else {
      local_8 = (int *)FUN_00110a5c(param_1,0x2b,lVar13,lVar14);
    }
    break;
  case 0x4f:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x24,uVar16,0);
    break;
  case 0x50:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x22,uVar16,0);
    break;
  case 0x52:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x23,uVar16,0);
    break;
  case 0x53:
    bVar7 = pbVar22[1];
...
LAB_00113a6c:
    piVar12 = local_8;
    uVar16 = FUN_00111a20(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,4,piVar12,uVar16);
    break;
  case 0x54:
    ...
    if (*__s1 == 'I') {
      ...
      if (**(char **)(param_1 + 0x18) == 'I') {
        ...
        *(int **)(*(longlong *)(param_1 + 0x30) + (longlong)iVar10 * 8) = local_8;
        *(int *)(param_1 + 0x38) = iVar10 + 1;
        local_8 = (int *)FUN_00110a5c(param_1,4,local_8,uVar16);
      }
      else {
        *(char **)(param_1 + 0x18) = __s1;
  ...
  case 0x55:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    ...
    uVar16 = FUN_00113660(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x21,uVar16,local_8);
    break;
  case 0x61:
  case 0x62:
  case 99:
  ...
  case 0x7a:
    ...
    if (iVar10 < *(int *)(param_1 + 0x2c)) {
      *(int *)(param_1 + 0x28) = iVar10 + 1;
      ...
      if (lVar13 != 0) {
        *(undefined4 *)(*(longlong *)(param_1 + 0x20) + (longlong)iVar10 * 0x18) = 0x27;
        *(longlong *)(lVar13 + 8) = (longlong)&PTR_s_signed_char_0013a840 + uVar15;
        iVar10 = *(int *)(&DAT_0013a848 + uVar15);
        *(byte **)(param_1 + 0x18) = pbVar22 + 1;
  ...
  case 0x75:
    *(byte **)(param_1 + 0x18) = pbVar22 + 1;
    uVar16 = FUN_00111670(param_1);
    local_8 = (int *)FUN_00110a5c(param_1,0x28,uVar16,0);
  }
LAB_001137c0:
  if (local_8 != (int *)0x0) {
LAB_001137c4:
...
switchD_00114718_caseD_1:
  ...
  if (((cVar8 == 'm') || (cVar8 == 'p')) && (__s1[1] == cVar8)) {
    ...
    if (bVar7 != 0x5f) {
      uVar16 = FUN_00116378(param_1,(ulonglong)bVar7,0);
      uVar16 = FUN_00110a5c(param_1,0x38,uVar16,uVar16);
      goto LAB_00113f04;
    }
    *(byte **)(param_1 + 0x18) = *(byte **)(param_1 + 0x18) + 1;
...
longlong FUN_00114d08(longlong param_1)
...
longlong FUN_00114e18(longlong param_1)

{
      ...
      if (bVar10 == 0x76) {
        ...
        if ((bVar11 == 0x76) && (bVar10 == 99)) {
          ...
          *(uint *)(param_1 + 0x58) = (uint)(*(int *)(param_1 + 0x54) == 0);
          uVar5 = FUN_00113660();
          if (*(int *)(param_1 + 0x58) == 0) {
            uVar5 = FUN_00110a5c(param_1,0x33,uVar5,0);
            *(undefined4 *)(param_1 + 0x58) = uVar3;
          }
          else {
            uVar5 = FUN_00110a5c(param_1,0x34,uVar5,0);
            *(undefined4 *)(param_1 + 0x58) = uVar3;
          }
          return uVar5;
        }
  ...
  do {
    ...
    bVar4 = *(&PTR_DAT_0013ade8)[(longlong)iVar1 * 3];
    if (bVar10 == bVar4) {
      bVar4 = (&PTR_DAT_0013ade8)[(longlong)iVar1 * 3][1];
      if (bVar11 == bVar4) {
        iVar8 = *(int *)(param_1 + 0x28);
        if (*(int *)(param_1 + 0x2c) <= iVar8) {
          return 0;
        ...
        *(int *)(param_1 + 0x28) = iVar8 + 1;
        ...
        if (lVar6 != 0) {
          ...
          *(undefined ***)(lVar6 + 8) = &PTR_DAT_0013ade8 + (longlong)iVar1 * 3;
          return lVar6;
        }
        return 0;
      }
      if (bVar4 <= bVar11) goto LAB_00114eb0;
    }
    else {
      if (bVar4 <= bVar10) {
LAB_00114eb0:
...
int * FUN_0011500c(longlong param_1)
          ...
          *(char **)(param_1 + 0x18) = pcVar7 + 1;
          if (pcVar7[1] == '_') {
            ...
            *(char **)(param_1 + 0x18) = __s1;
            ...
            pcVar7 = *(char **)(param_1 + 0x18);
            cVar9 = *pcVar7;
            if (cVar9 != '_') goto joined_r0x00115164;
            iVar3 = iVar3 + 1;
            __s1 = pcVar7 + 1;
            *(char **)(param_1 + 0x18) = __s1;
            if (iVar3 < 0) {
...
LAB_001150c4:
      ...
      if ((lVar6 < 1) || (bVar11)) goto LAB_00115194;
...
longlong FUN_00115590(longlong param_1)

{
  ...
  case 0x4e:
    *(undefined **)(param_1 + 0x18) = puVar11 + 1;
    plVar5 = (longlong *)FUN_00110b5c(param_1,&local_8,1);
    if (plVar5 == (longlong *)0x0) {
      return 0;
    }
    pcVar4 = *(char **)(param_1 + 0x18);
...
LAB_001159ec:
    ...
    *(char **)(param_1 + 0x18) = pcVar4 + 1;
    lVar14 = 0;
    lVar3 = FUN_00110a5c(param_1,uVar7,0,0);
    pcVar4 = *(char **)(param_1 + 0x18);
    cVar13 = *pcVar4;
LAB_0011570c:
    do {
...
LAB_0011590c:
          ...
          if (cVar13 == 'S') {
            lVar9 = FUN_00110d0c(param_1,1);
            if (lVar14 != 0) {
LAB_001158f8:
              uVar7 = 1;
LAB_001158fc:
              lVar9 = FUN_00110a5c(param_1,uVar7,lVar14,lVar9);
              goto LAB_0011590c;
            }
            pcVar4 = *(char **)(param_1 + 0x18);
            cVar13 = *pcVar4;
...
LAB_00115948:
  ...
  default:
    ...
    if (**(char **)(param_1 + 0x18) == 'I') {
      ...
      *(int *)(param_1 + 0x38) = iVar1 + 1;
      uVar7 = FUN_00111a20(param_1);
      lVar3 = FUN_00110a5c(param_1,4,lVar3,uVar7);
    }
    break;
  case 0x53:
    if (puVar11[1] == 't') {
      *(undefined **)(param_1 + 0x18) = puVar11 + 2;
      uVar7 = FUN_00110afc(param_1,&DAT_00124ad0,3);
      uVar6 = FUN_0011500c(param_1);
      lVar3 = FUN_00110a5c(param_1,1,uVar7,uVar6);
    ...
    *(char **)(param_1 + 0x18) = pcVar4 + 1;
    if (pcVar4[1] == 's') {
      *(char **)(param_1 + 0x18) = pcVar4 + 2;
      ...
      piVar12 = (int *)FUN_00110afc(param_1,"string literal",0xe);
    }
    else {
      if (pcVar4[1] == 'd') {
        *(char **)(param_1 + 0x18) = pcVar4 + 2;
        ...
        piVar10 = (int *)FUN_00115590(param_1);
        ...
        piVar12 = (int *)FUN_00115590(param_1);
        if (((piVar12 != (int *)0x0) && (*piVar12 != 0x45)) &&
           ((*piVar12 != 0x47 && (iVar1 = FUN_001117a4(param_1), iVar1 == 0)))) {
          return 0;
        }
      }
    }
    uVar7 = FUN_00110a5c(param_1,2,uVar7,piVar12);
    return uVar7;
  }
  return lVar3;
}
...
uint * FUN_00115b3c(longlong param_1,int param_2)
  ...
  *(int *)(param_1 + 0x50) = iVar4 + 0x14;
  if (*pcVar9 == 'T') {
    ...
    *(char **)(param_1 + 0x18) = pcVar9 + 2;
    switch(pcVar9[1]) {
    case 'C':
      lVar10 = FUN_00113660(param_1);
      lVar6 = FUN_00111110(param_1 + 0x18);
      if (lVar6 < 0) {
        return (uint *)0;
      }
      if (**(char **)(param_1 + 0x18) != '_') {
      ...
      *(char **)(param_1 + 0x18) = *(char **)(param_1 + 0x18) + 1;
      puVar12 = (uint *)FUN_00113660(param_1);
      uVar8 = 0xb;
    ...
    case 'F':
      ...
      break;
    case 'H':
      puVar12 = (uint *)FUN_00115590(param_1);
      uVar8 = 0x14;
      lVar10 = 0;
      break;
    case 'I':
    ...
    case 'c':
      ...
      puVar12 = (uint *)FUN_00115b3c(param_1,0);
      uVar8 = 0x11;
      lVar10 = 0;
      break;
    case 'h':
  ...
  case 'R':
    ...
    if (iVar4 < *(int *)(param_1 + 0x2c)) {
      *(int *)(param_1 + 0x28) = iVar4 + 1;
      ...
      if (lVar10 == 0) goto LAB_001161e4;
      *(undefined4 *)(*(longlong *)(param_1 + 0x20) + (longlong)iVar4 * 0x18) = 0x41;
      uVar8 = FUN_00111110(param_1 + 0x18);
...
LAB_001161e4:
  ...
  case 'V':
    ...
    break;
  case 'r':
    lVar10 = FUN_00111110(param_1 + 0x18);
    if (lVar10 < 2) {
      return (uint *)0;
    }
    pcVar9 = *(char **)(param_1 + 0x18);
...
LAB_001161ec:
        ...
        *(int *)(param_1 + 0x28) = iVar4 + 1;
        ...
        if (puVar12 == (uint *)0x0) goto LAB_001161ec;
        ...
        *(char **)(param_1 + 0x18) = pcVar14;
        ...
        lVar6 = -uVar13;
        puVar12 = (uint *)FUN_00110afc(param_1,pcVar14,uVar13 & 0xffffffff);
      ...
      lVar10 = lVar10 + lVar6;
      if ((puVar11 != (uint *)0x0) &&
         (puVar12 = (uint *)FUN_00110a5c(param_1,0x3f,puVar11), puVar12 == (uint *)0x0)) {
        return (uint *)0;
      }
      puVar11 = puVar12;
    } while (0 < lVar10);
  ...
  goto LAB_00115cfc;
joined_r0x00115c84:
  if (puVar11 == (uint *)0x0) goto LAB_00115cb0;
  uVar5 = *puVar11;
  if (8 < uVar5) {
...
LAB_00115cc8:
    lVar6 = FUN_00114d08(param_1);
    if (lVar6 == 0) goto LAB_001161dc;
    lVar10 = FUN_00110a5c(param_1,0x29,lVar10,lVar6);
  }
  uVar8 = 3;
LAB_00115cfc:
  uVar8 = FUN_00110a5c(param_1,uVar8,puVar12,lVar10);
  return (uint *)uVar8;
}



undefined8 FUN_00116200(longlong param_1)

{
  ...
  *(char **)(param_1 + 0x18) = pcVar4;
  cVar3 = pcVar6[1];
  if (cVar3 == 'Z') {
    if (cVar3 == '_') goto LAB_00116328;
  }
  else {
    if (cVar3 != '_') {
      piVar1 = (int *)FUN_00113660();
      if (piVar1 == (int *)0x0) {
        return 0;
      }
      ...
      uVar2 = FUN_00110afc(param_1,pcVar6,uVar5);
      uVar7 = FUN_00110a5c(param_1,uVar7,piVar1,uVar2);
      pcVar4 = *(char **)(param_1 + 0x18);
      cVar3 = *pcVar4;
      goto LAB_001162d8;
    }
...
int * FUN_00116378(longlong param_1)
...
LAB_001163c4:
        piVar7 = (int *)FUN_0011500c(param_1);
        if (piVar7 == (int *)0x0) {
          return (int *)0;
        }
        if (**(char **)(param_1 + 0x18) != 'I') {
      ...
      if (cVar2 == 'o') {
        ...
        if (((cVar2 == 't') || (cVar2 == 'i')) && (__s1[1] == 'l')) {
          piVar7 = (int *)0x0;
          if (cVar2 == 't') {
            piVar7 = (int *)FUN_00113660(param_1);
            __s1 = *(char **)(param_1 + 0x18);
          }
          *(char **)(param_1 + 0x18) = __s1 + 2;
  ...
  piVar7 = (int *)FUN_00114e18(param_1);
  if (piVar7 == (int *)0x0) {
    return (int *)0;
  }
  iVar3 = *piVar7;
  if (iVar3 == 0x31) {
    ...
    *(int *)(param_1 + 0x50) = *(int *)(param_1 + 0x50) + *(int *)(ppcVar9 + 2) + -2;
    ...
    if (iVar3 == 0x32) {
      switch(piVar7[2]) {
      case 0:
switchD_00116690_caseD_0:
        uVar6 = 0x35;
        uVar4 = 0;
LAB_001165a4:
        uVar4 = FUN_00110a5c(param_1,uVar6,piVar7,uVar4);
        return (int *)uVar4;
      case 1:
...
undefined8 FUN_001169e0(longlong param_1)
...
void FUN_00119244(undefined *param_1,uint param_2,longlong *param_3)

{
  ...
  if (param_3 == (longlong *)0x0) goto LAB_001192c0;
...
LAB_0011b940:
  ...
  case 1:
  case 2:
    FUN_00119244(param_1,(ulonglong)param_2,param_3[1]);
    lVar13 = *(longlong *)(param_1 + 0x100);
    if ((param_2 >> 2 & 1) == 0) {
      if (lVar13 == 0xff) {
        param_1[0xff] = 0;
...
LAB_00119394:
        ...
        *(longlong *)(param_1 + 0x100) = lVar19;
        param_1[lVar13] = 0x3a;
        param_1[0x108] = 0x3a;
        if (lVar19 != 0xff) goto LAB_00119394;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        lVar13 = 1;
        lVar19 = 0;
    ...
    if (*piVar12 == 0x46) {
      ...
      FUN_001115a4(param_1,(longlong)(piVar12[4] + 1));
      FUN_0011139c(param_1,&DAT_00124ae8);
      piVar12 = *(int **)(piVar12 + 2);
    }
    FUN_00119244(param_1,(ulonglong)param_2,piVar12);
    break;
  case 3:
...
LAB_0011c8b0:
        ...
        if (iVar8 == 4) {
          *(longlong *****)(param_1 + 0x120) = &local_90;
          ...
          local_88 = plVar21;
LAB_0011c9d0:
          FUN_00119244(param_1,(ulonglong)param_2,param_3[2]);
          if (*(int *)plVar21 == 4) {
            *(longlong ****)(param_1 + 0x120) = local_90;
          }
          uVar17 = uVar35 - 1;
          if (*(int *)(&local_70 + (ulonglong)uVar17 * 4) == 0) {
            ...
            FUN_0011cc50(param_1,(ulonglong)param_2,(&local_78)[(ulonglong)uVar17 * 4]);
          }
          if (uVar17 != 0) {
            uVar17 = uVar35 - 2;
            if (*(int *)(&local_70 + (ulonglong)uVar17 * 4) == 0) {
            ...
            if (uVar17 != 0) {
              ...
              if (*(int *)(&local_70 + (ulonglong)uVar35 * 4) == 0) {
                FUN_00111098(param_1,0x20);
                FUN_0011cc50(param_1,(ulonglong)param_2,(&local_78)[(ulonglong)uVar35 * 4]);
              }
              if ((uVar35 != 0) && ((int)local_70 == 0)) {
                FUN_00111098(param_1,0x20);
                FUN_0011cc50(param_1,(ulonglong)param_2,local_78);
  ...
  case 4:
    ...
    *(undefined8 *)(param_1 + 0x160) = uVar37;
    break;
  case 5:
    piVar12 = (int *)FUN_00111198(param_1,param_3 + 1);
    if (piVar12 != (int *)0x0) {
      if (*piVar12 != 0x2f) {
LAB_0011a45c:
        puVar31 = *(undefined8 **)(param_1 + 0x120);
        *(undefined8 *)(param_1 + 0x120) = *puVar31;
        FUN_00119244(param_1,(ulonglong)param_2);
        *(undefined8 **)(param_1 + 0x120) = puVar31;
        return;
      }
      ...
      while (0 < iVar8) {
        ...
        iVar8 = iVar8 + -1;
        if ((piVar12 == (int *)0x0) || (*piVar12 != 0x2f)) goto LAB_001192c0;
      }
      if ((iVar8 == 0) && (*(longlong *)(piVar12 + 2) != 0)) goto LAB_0011a45c;
    }
    goto LAB_001192c0;
  case 6:
    lVar19 = param_3[1];
...
LAB_0011b354:
          ...
          *(longlong *)(param_1 + 0x100) = lVar10;
          param_1[lVar14] = 0x72;
          param_1[0x108] = 0x72;
          if (lVar10 != 0xff) goto LAB_0011b370;
          param_1[0xff] = 0;
          (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
          *param_1 = 0x6d;
          lVar13 = 1;
        ...
        *(longlong *)(param_1 + 0x100) = lVar13;
        param_1[lVar14] = 0x70;
        param_1[0x108] = 0x70;
        if (lVar13 != 0xff) goto LAB_0011b338;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        *param_1 = 0x61;
        lVar10 = 2;
...
LAB_00119cc0:
      ...
      *(longlong *)(param_1 + 0x100) = lVar19;
      param_1[lVar13] = 0x69;
      param_1[0x108] = 0x69;
      if (lVar19 != 0xff) goto LAB_00119cdc;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      lVar13 = 1;
      lVar19 = 0;
      ...
      *(longlong *)(param_1 + 0x100) = lVar19;
      ...
      if (lVar19 == 0xff) {
        ...
        *(longlong *)(param_1 + 0x100) = lVar13;
        param_1[lVar19] = 0x68;
        param_1[0x108] = 0x68;
        if (lVar13 != 0xff) goto LAB_00119cc0;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        *param_1 = 0x69;
        lVar19 = 1;
...
LAB_0011b10c:
      ...
      *(longlong *)(param_1 + 0x100) = lVar19;
      param_1[lVar13] = 0x6e;
      param_1[0x108] = 0x6e;
      if (lVar19 != 0xff) goto LAB_0011b128;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      lVar13 = 1;
      lVar19 = 0;
      ...
      *(longlong *)(param_1 + 0x100) = lVar19;
      ...
      if (lVar19 == 0xff) {
        ...
        *(longlong *)(param_1 + 0x100) = lVar13;
        param_1[lVar19] = 0x69;
        param_1[0x108] = 0x69;
        if (lVar13 != 0xff) goto LAB_0011b10c;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        *param_1 = 0x6e;
        lVar19 = 1;
...
LAB_00119b60:
    plVar21 = local_78;
    local_70._0_4_ = 0;
    FUN_00119244(param_1,(ulonglong)param_2,lVar13);
    if ((int)local_70 == 0) {
      FUN_0011cc50(param_1,(ulonglong)param_2,plVar21);
    }
    *(longlong ***)(param_1 + 0x128) = local_80;
    if (bVar7) {
...
LAB_0011b68c:
        *puVar31 = 0;
        bVar7 = false;
        plVar21 = (longlong *)FUN_00111198(param_1,plVar21 + 1);
        if (plVar21 == (longlong *)0x0) goto LAB_001192c0;
LAB_0011b84c:
        iVar8 = *(int *)plVar21;
        if (iVar8 != 0x2f) goto LAB_00119b9c;
        iVar8 = *(int *)(param_1 + 0x134);
        while (0 < iVar8) {
          plVar21 = (longlong *)plVar21[2];
          iVar8 = iVar8 + -1;
          if ((plVar21 == (longlong *)0x0) || (*(int *)plVar21 != 0x2f)) goto LAB_001192b8;
        }
...
LAB_001192b8:
        ...
        if (plVar21 != *pplVar27) {
          do {
            pplVar11 = pplVar11 + 2;
            if (pplVar11 == pplVar27 + ((ulonglong)(uVar35 - 1) + 1) * 2) goto LAB_0011b608;
        ...
        *(longlong **)(param_1 + 0x120) = pplVar11[1];
        bVar7 = true;
        plVar21 = (longlong *)FUN_00111198(param_1,plVar21 + 1);
        if (plVar21 != (longlong *)0x0) goto LAB_0011b84c;
      }
      *(undefined8 *)(param_1 + 0x120) = unaff_x22;
LAB_001192c0:
      *(undefined4 *)(param_1 + 0x130) = 1;
    ...
    if ((param_2 >> 5 & 1) == 0) {
      if ((param_3[1] != 0) && ((param_2 >> 6 & 1) == 0)) {
        ...
        *(longlong ****)(param_1 + 0x128) = &local_80;
        ...
        local_70._0_4_ = 0;
        local_78 = param_3;
        FUN_00119244(param_1,(ulonglong)(param_2 & 0xffffff9f),param_3[1]);
        *(longlong ***)(param_1 + 0x128) = local_80;
        if ((int)local_70 != 0) {
          return;
        }
      ...
      FUN_0011daac(param_1,(ulonglong)(param_2 & 0xffffff9f),param_3 + 2,
      ...
      FUN_0011daac(param_1,(ulonglong)(param_2 & 0xffffff9f),param_3 + 2,
                   *(undefined8 *)(param_1 + 0x128));
      if (param_3[1] != 0) {
        FUN_00119244(param_1,(ulonglong)(param_2 & 0xffffff9f));
      }
    }
    break;
  case 0x2a:
      ...
      *(longlong ***)(param_1 + 0x128) = pplVar27;
      ...
      if ((int)uVar36 != 1) {
        do {
          uVar35 = (int)uVar36 - 1;
          uVar36 = (ulonglong)uVar35;
          FUN_0011cc50(param_1,(ulonglong)param_2,(&local_78)[uVar36 * 4]);
        } while (uVar35 != 1);
        pplVar27 = *(longlong ***)(param_1 + 0x128);
      }
    }
    FUN_0011d7e4(param_1,(ulonglong)param_2,param_3 + 1,pplVar27);
    break;
  case 0x2b:
  case 0x2d:
    local_80 = *(longlong ***)(param_1 + 0x128);
    *(longlong ****)(param_1 + 0x128) = &local_80;
    ...
    FUN_00119244(param_1,(ulonglong)param_2,param_3[2]);
    if ((int)local_70 == 0) {
      FUN_0011cc50(param_1,(ulonglong)param_2,param_3);
    }
    *(longlong ***)(param_1 + 0x128) = local_80;
    break;
  case 0x2c:
...
LAB_0011b560:
        ...
        *(longlong *)(param_1 + 0x100) = lVar13;
        param_1[lVar19] = 0x74;
        param_1[0x108] = 0x74;
        if (lVar13 != 0xff) goto LAB_0011b57c;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        lVar19 = 1;
        lVar13 = 0;
        ...
        *(longlong *)(param_1 + 0x100) = lVar13;
        param_1[lVar19] = 0x53;
        param_1[0x108] = 0x53;
        if (lVar13 != 0xff) goto LAB_0011b544;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        *param_1 = 0x61;
        lVar13 = 2;
...
LAB_0011b57c:
    ...
    if (*(longlong *)(param_3[1] + 8) == 0x13a940) {
      lVar13 = *(longlong *)(param_1 + 0x100);
    }
    else {
      FUN_00119244(param_1,(ulonglong)param_2);
...
LAB_0011b27c:
          ...
          *(longlong *)(param_1 + 0x100) = lVar14;
          param_1[lVar19] = 0x61;
          param_1[0x108] = 0x61;
          if (lVar14 != 0xff) goto LAB_0011b298;
          param_1[0xff] = 0;
          (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
          *param_1 = 99;
          lVar13 = 1;
        ...
        *(longlong *)(param_1 + 0x100) = lVar13;
        param_1[lVar19] = 0x46;
        param_1[0x108] = 0x46;
        if (lVar13 != 0xff) goto LAB_0011b260;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        *param_1 = 0x72;
        lVar14 = 2;
...
LAB_0011a7f0:
        ...
        *(longlong *)(param_1 + 0x100) = lVar14;
        param_1[lVar19] = 99;
        param_1[0x108] = 99;
        if (lVar14 != 0xff) goto LAB_0011a80c;
        param_1[0xff] = 0;
        (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
        *param_1 = 0x75;
        lVar13 = 1;
...
LAB_0011a828:
      ...
      *(longlong *)(param_1 + 0x100) = lVar13;
      param_1[lVar19] = 0x41;
      param_1[0x108] = 0x41;
      if (lVar13 != 0xff) goto LAB_0011a7d4;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      *param_1 = 99;
      lVar14 = 2;
...
LAB_0011a80c:
      ...
      *(longlong *)(param_1 + 0x100) = lVar13;
      param_1[lVar14] = 0x75;
      param_1[0x108] = 0x75;
      if (lVar13 != 0xff) goto LAB_0011a828;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      lVar19 = 1;
      lVar13 = 0;
  ...
  case 0x34:
    ...
    if (*(int *)param_3[1] == 4) {
      FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)((int *)param_3[1] + 2));
      ...
      *(longlong *)(param_1 + 0x100) = lVar13 + 1;
      param_1[lVar13] = 0x3c;
      param_1[0x108] = 0x3c;
      FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)(param_3[1] + 0x10));
      if (param_1[0x108] == '>') {
        lVar13 = *(longlong *)(param_1 + 0x100);
        if (lVar13 == 0xff) {
          param_1[0xff] = 0;
    ...
    break;
  case 0x35:
    FUN_0011dd5c(param_1,(ulonglong)param_2,param_3[1]);
    break;
  case 0x36:
...
LAB_0011b6d4:
        if (iVar8 == 0x38) {
          FUN_0011de30(param_1,(ulonglong)param_2,*(undefined8 *)(piVar12 + 2));
          FUN_0011dd5c(param_1,(ulonglong)param_2,piVar23);
          return;
        }
      }
      FUN_0011dd5c(param_1,(ulonglong)param_2,piVar23);
      ...
      if (*piVar23 == 0x33) {
        ...
        *(longlong *)(param_1 + 0x100) = lVar13 + 1;
        param_1[lVar13] = 0x28;
        param_1[0x108] = 0x28;
        FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)(piVar23 + 2));
    ...
    FUN_0011de30(param_1,(ulonglong)param_2,piVar12);
    break;
  case 0x37:
    piVar12 = (int *)param_3[2];
    if (*piVar12 != 0x38) goto LAB_001192c0;
    ppcVar24 = *(char ***)((int *)param_3[1] + 2);
    __s1 = *ppcVar24;
    if ((__s1[1] == 'c') && (((byte)(*__s1 + 0x8eU) < 2 || ((byte)(*__s1 + 0x9dU) < 2)))) {
      FUN_0011dd5c(param_1,(ulonglong)param_2);
      FUN_00111098(param_1,0x3c);
      FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)(param_3[2] + 8));
      FUN_0011139c(param_1,&DAT_00124d90);
      FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)(param_3[2] + 0x10));
      FUN_00111098(param_1,0x29);
    }
    else {
      ...
      if ((iVar8 == 0) && (*piVar12 == 3)) {
        ...
        FUN_0011de30(param_1,(ulonglong)param_2);
      }
      lVar13 = param_3[1];
      __s1 = **(char ***)(lVar13 + 8);
      ...
      if (iVar8 == 0) {
        ...
        iVar8 = strcmp(__s1,"cl");
        if (iVar8 != 0) {
          FUN_0011dd5c(param_1,(ulonglong)param_2,lVar13);
        }
        FUN_0011de30(param_1,(ulonglong)param_2,*(undefined8 *)(param_3[2] + 0x10));
      }
  ...
  case 0x39:
    ...
    if (iVar8 == 0) {
      FUN_0011de30(param_1,(ulonglong)param_2);
      FUN_0011dd5c(param_1,(ulonglong)param_2,lVar14);
      FUN_0011de30(param_1,(ulonglong)param_2,uVar37);
      FUN_0011139c(param_1,&DAT_00124cc8);
      FUN_0011de30(param_1,(ulonglong)param_2,lVar19);
    }
    else {
      ...
      FUN_00119244(param_1,(ulonglong)param_2,uVar37);
      if (lVar19 != 0) {
        FUN_0011de30(param_1,(ulonglong)param_2,lVar19);
      }
    }
...
LAB_0011afac:
      ...
      *(longlong *)(param_1 + 0x100) = lVar19;
      param_1[lVar13] = 0x29;
      param_1[0x108] = 0x29;
      if (lVar19 != 0xff) goto LAB_0011afac;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      lVar13 = 1;
      lVar19 = 0;
  ...
  case 0x4a:
    iVar8 = 0;
    piVar12 = (int *)FUN_00111214(param_1,param_3[1]);
    if (piVar12 == (int *)0x0) {
      FUN_0011de30(param_1,(ulonglong)param_2,param_3[1]);
...
LAB_0011a2a4:
            ...
            *(longlong *)(param_1 + 0x100) = lVar14;
            param_1[lVar19] = 0x2c;
            param_1[0x108] = 0x2c;
            if (lVar14 != 0xff) goto LAB_0011a2a4;
            param_1[0xff] = 0;
            (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
            lVar19 = 1;
            lVar14 = 0;
...
LAB_0011a338:
      ...
      *(longlong *)(param_1 + 0x100) = lVar13;
      param_1[lVar19] = 0x69;
      param_1[0x108] = 0x69;
      if (lVar13 != 0xff) goto LAB_0011a354;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      lVar19 = 1;
      lVar13 = 0;
      ...
      *(longlong *)(param_1 + 0x100) = lVar13;
      param_1[lVar19] = 0x61;
      param_1[0x108] = 0x61;
      if (lVar13 != 0xff) goto LAB_0011a31c;
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      *param_1 = 0x62;
      lVar13 = 2;
...

{
  ...
  default:
LAB_0011cc8c:
    FUN_00119244(param_1,(ulonglong)param_2,param_3);
    return;
  case 0x19:
  case 0x1c:
    lVar2 = 0;
...
LAB_0011cf78:
  ...
  case 0x2b:
    ...
    FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)(param_3 + 2));
    lVar2 = *(longlong *)(param_1 + 0x100);
    if (lVar2 == 0xff) {
      param_1[0xff] = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
      ...
      if (*(int *)(param_3 + 2) == 0) {
        ...
        if ((param_4 != 0) || (4 < iVar2 - 0x1cU)) {
          ...
          *(undefined8 *)(param_1 + 0x120) = param_3[3];
          if (iVar2 == 0x29) {
            FUN_0011daac(param_1,(ulonglong)param_2,piVar5 + 4,*param_3);
            *(undefined8 *)(param_1 + 0x120) = uVar8;
            return;
          }
          if (iVar2 == 0x2a) {
            FUN_0011d7e4(param_1,(ulonglong)param_2,piVar5 + 2,*param_3);
            *(undefined8 *)(param_1 + 0x120) = uVar8;
            return;
          }
          if (iVar2 == 2) {
            ...
            *(undefined8 *)(param_1 + 0x128) = 0;
            FUN_00119244(param_1,(ulonglong)param_2,*(undefined8 *)(piVar5 + 2));
...
LAB_0011d664:
            ...
            FUN_001115a4(param_1,(longlong)(piVar5[4] + 1));
            FUN_0011139c(param_1,&DAT_00124ae8);
            do {
              piVar5 = *(int **)(piVar5 + 2);
              iVar2 = *piVar5;
LAB_0011d684:
            ...
            FUN_00119244(param_1,(ulonglong)param_2,piVar5);
            *(undefined8 *)(param_1 + 0x120) = uVar8;
            return;
          }
          FUN_0011cc50(param_1,(ulonglong)param_2);
          *(undefined8 *)(param_1 + 0x120) = uVar8;
        }
      }
...
void FUN_0011d7e4(undefined *param_1,uint param_2,longlong *param_3,longlong *param_4)
    ...
    do {
      if (*(int *)(plVar1 + 2) == 0) {
        if (*(int *)plVar1[1] == 0x2a) {
          FUN_0011d4d0(param_1,(ulonglong)param_2,param_4,0);
          lVar3 = *(longlong *)(param_1 + 0x100);
...
void FUN_0011daac(undefined *param_1,uint param_2,longlong *param_3,longlong *param_4)
...
LAB_0011dbec:
      ...
      default:
        ...
        if (plVar3 != (longlong *)0x0) goto code_r0x0011db14;
        goto LAB_0011db1c;
      case 0x22:
      case 0x23:
      case 0x24:
...
LAB_0011db7c:
  *(longlong *)(param_1 + 0x100) = lVar5;
  param_1[lVar4] = 0x29;
  param_1[0x108] = 0x29;
  FUN_0011d4d0(param_1,(ulonglong)param_2,param_4,1);
  *(undefined8 *)(param_1 + 0x128) = uVar6;
  return;
code_r0x0011db14:
  iVar1 = *(int *)(plVar3 + 2);
...
void FUN_0011de30(longlong param_1,ulonglong param_2,uint *param_3)

{
  ...
  if ((uVar1 != 0x30 && 1 < uVar1) && (uVar1 != 6)) {
    ...
    *(undefined *)(param_1 + 0x108) = 0x28;
    FUN_00119244(param_1,param_2 & 0xffffffff,param_3);
    lVar3 = *(longlong *)(param_1 + 0x100);
    if (lVar3 == 0xff) {
      *(undefined *)(param_1 + 0xff) = 0;
      (**(code **)(param_1 + 0x110))(param_1,0xff,*(undefined8 *)(param_1 + 0x118));
...
ulonglong FUN_0011df38(char *param_1,code *param_2,undefined8 param_3)

{
  ...
  if (iVar9 == 1) {
    ...
    local_1b0 = param_1 + 2;
    lVar11 = FUN_00115b3c(&local_1c8,1);
    if ((local_1b8 & 1) == 0) {
LAB_0011e358:
      cVar12 = *local_1b0;
    }
      ...
      while (pcVar5 = local_1b0, cVar12 = *local_1b0, cVar12 == '.') {
        ...
        if (((byte)(cVar12 + 0x9fU) < 0x1a) || (cVar12 == '_')) {
          cVar12 = local_1b0[2];
          pcVar14 = local_1b0 + 2;
          if (0x19 < (byte)(cVar12 + 0x9fU)) goto LAB_0011e34c;
          do {
            do {
              pcVar14 = pcVar14 + 1;
              cVar12 = *pcVar14;
...
LAB_0011e34c:
          ...
          if (9 < (byte)(cVar12 - 0x30U)) goto LAB_0011e358;
          cVar12 = *local_1b0;
          pcVar14 = local_1b0;
        }
        while (cVar12 == '.') {
...
LAB_0011e2dc:
        iVar7 = (int)local_1b0;
        local_1b0 = pcVar14;
        uVar10 = FUN_00110afc(&local_1c8,pcVar5,(ulonglong)(uint)((int)pcVar14 - iVar7));
        lVar11 = FUN_00110a5c(&local_1c8,0x4c,lVar11,uVar10);
      }
    }
  }
  else {
    if (iVar9 == 0) {
      lVar11 = FUN_00113660(&local_1c8);
      cVar12 = *local_1b0;
    }
    else {
      ...
      if ((param_1[0xb] == '_') && (param_1[0xc] == 'Z')) {
        ...
        uVar10 = FUN_00115b3c(&local_1c8,0,0x44);
      }
      else {
        local_1d8 = local_1b0;
        sVar8 = strlen(local_1b0,(&stack0xfffffffffffffde0)[lVar3 + lVar2]);
        uVar10 = FUN_00110afc(&local_1c8,local_1d8,(ulonglong)sVar8);
      }
      lVar11 = FUN_00110a5c(&local_1c8,(ulonglong)uVar13,uVar10,0);
      pcVar5 = local_1b0;
      sVar8 = strlen(local_1b0,(&stack0xfffffffffffffde0)[lVar3 + lVar2]);
  ...
  if ((cVar12 == '\0') && (lVar11 != 0)) {
    ...
    local_10 = 0;
    local_c = 0;
    FUN_00110fcc(&local_c,&local_1c,lVar11);
    local_8 = 0;
    ...
    local_18 = &stack0xfffffffffffffde0 +
               ...
               0x10));
    FUN_00119244(auStack360,0x11,lVar11);
    uVar10 = local_50;
    pcVar6 = local_58;
    lVar2 = local_68;
...
void FUN_0011e544(byte *param_1,ulonglong *param_2)
...
void FUN_0011e56c(byte *param_1,ulonglong *param_2)
...
ulonglong ** FUN_0011e5ac(byte param_1,ulonglong **param_2,ulonglong **param_3,ulonglong **param_4)

{
  ...
  if (param_1 == 0x50) {
    ...
    case 0xc:
      ...
      break;
    case 1:
      ppuVar1 = (ulonglong **)FUN_0011e544(param_3,&local_8);
      break;
    case 2:
    ...
    default:
      ...
      abort();
    case 9:
      ppuVar1 = (ulonglong **)FUN_0011e56c(param_3,&local_8);
      break;
    case 10:
      ppuVar1 = (ulonglong **)((longlong)param_3 + 2);
      local_8 = (ulonglong **)(longlong)*(short *)param_3;
...
void FUN_0011e7b0(longlong param_1,undefined8 param_2,undefined8 *param_3)
...
longlong FUN_0011e844(longlong param_1,longlong param_2)

{
  ...
  if ((((*(ulonglong *)(param_2 + 0x340) >> 0x3e & 1) == 0) || (*(char *)(param_2 + 0x377) == '\0'))
    ...
    FUN_0011e7b0(param_2,*(undefined8 *)(param_2 + 0x310),auStack8);
  }
  lVar1 = 0;
  while( true ) {
    ...
    if ((*(char *)(param_2 + lVar1 + 0x358) == '\0') || (__dest == (void **)0x0)) {
      if ((__dest != (void **)0x0 && __src != (void **)0x0) && (__src != __dest)) {
        memcpy(__dest,__src,(uint)(byte)(&DAT_0014e360)[lVar1]);
      }
    }
    else {
...
void FUN_0011ea94(byte *param_1,byte *param_2,longlong param_3,longlong param_4)
...
code_r0x0011eb5c:
  ...
  case 1:
    ...
    uVar7 = FUN_0011ea1c(local_28,param_3);
    param_1 = (byte *)FUN_0011e5ac((ulonglong)local_28 & 0xffffffff,uVar7,param_1,&local_8);
...
LAB_0011ebfc:
  ...
  case 7:
    ...
    goto LAB_0011eadc;
  case 9:
    uVar7 = FUN_0011e544(param_1,&local_18);
    param_1 = (byte *)FUN_0011e544(uVar7,&local_8);
  ...
  case 0xb:
    ...
    *(undefined **)(local_28 + 0x620) = puVar14;
    ...
    goto LAB_0011eadc;
  case 0xc:
    uVar7 = FUN_0011e544(param_1,&local_10);
    *(longlong *)(param_4 + 0x630) = local_10;
    param_1 = (byte *)FUN_0011e544(uVar7,&local_10);
...
LAB_0011ed40:
  ...
  case 0x11:
    uVar7 = FUN_0011e544(param_1,&local_18);
    param_1 = (byte *)FUN_0011e56c(uVar7,&local_8);
    lVar10 = *(longlong *)(param_4 + 0x658);
    lVar8 = local_8;
    break;
  case 0x12:
...
LAB_0011eebc:
    lVar8 = FUN_0011e544(param_1,&local_10);
...
undefined8 FUN_0011ef8c(longlong param_1,longlong *param_2)
...
LAB_0011f388:
    ...
    if (*(byte *)(puVar16 + 2) < 4) {
LAB_0011f164:
      uVar11 = FUN_0011e544(plVar7,&local_18);
      param_2[0xcc] = local_18;
      pbVar17 = (byte *)FUN_0011e56c(uVar11,&local_10);
      ...
      if (*(char *)(puVar16 + 2) == '\x01') {
        ...
        pbVar8 = (byte *)FUN_0011e544(pbVar17,&local_18);
        uVar12 = local_18;
      }
      param_2[0xcd] = uVar12;
      *(undefined *)((longlong)param_2 + 0x671) = 0xff;
      ...
      if (*__s == 'z') {
        __s = __s + 1;
        pbVar8 = (byte *)FUN_0011e544(pbVar8,&local_18);
...
LAB_0011f220:
          ...
          if (cVar2 == 'P') {
            bVar1 = *pbVar8;
            uVar11 = FUN_0011ea1c((ulonglong)bVar1,param_1);
            pbVar8 = (byte *)FUN_0011e5ac((ulonglong)bVar1,uVar11,pbVar8 + 1,&local_8);
...
LAB_0011f290:
      if (pbVar9 != (byte *)0x0) {
        FUN_0011ea94(pbVar9,(longlong)puVar16 + (ulonglong)*puVar16 + 4,param_1,param_2);
        ...
        if (*(char *)((longlong)param_2 + 0x672) != '\0') {
          lVar10 = FUN_0011e544(lVar10,&local_8);
          lVar5 = lVar10 + local_8;
        }
        bVar1 = *(byte *)((longlong)param_2 + 0x671);
        if (bVar1 != 0xff) {
          uVar11 = FUN_0011ea1c((ulonglong)bVar1,param_1);
          lVar10 = FUN_0011e5ac((ulonglong)bVar1,uVar11,lVar10,&local_8);
          *(longlong *)(param_1 + 800) = local_8;
        }
        if (lVar5 == 0) {
          lVar5 = lVar10;
        }
        FUN_0011ea94(lVar5,(longlong)puVar4 + (ulonglong)*puVar4 + 4,param_1,param_2);
        goto LAB_0011f388;
      }
    }
    else {
...
ulonglong * FUN_0011f3b0(byte *param_1,byte *param_2,undefined8 param_3,ulonglong *param_4)
...
LAB_0011f60c:
            ...
            if (bVar1 < 0xb) {
              if (bVar1 == 6) goto LAB_0011f748;
              if (bVar1 < 7) {
                if (bVar1 != 3) goto switchD_0011f83c_caseD_1f;
                param_1 = pbVar11 + 9;
                ...
                if (bVar1 == 8) {
                  ...
                  if (bVar1 != 9) goto switchD_0011f83c_caseD_1f;
              ...
              if (bVar1 == 0xd) {
                ...
                if (0xd < bVar1) {
                  ...
                  goto switchD_0011f83c_caseD_1f;
                }
                if (bVar1 == 0xb) {
                  puVar10 = (ulonglong *)(longlong)*(short *)(pbVar11 + 1);
                  goto LAB_0011f60c;
                }
                if (bVar1 != 0xc) goto switchD_0011f83c_caseD_1f;
          ...
          if (bVar1 == 0x15) {
            ...
            param_1 = pbVar11 + 2;
            if ((longlong)(int)(uVar13 - 1) <= (longlong)local_210) goto switchD_0011f83c_caseD_1f;
            puVar10 = local_200[(longlong)(int)(uVar13 - 1) - local_210];
          }
          else {
            if (0x15 < bVar1) {
              if (bVar1 == 0x19) goto LAB_0011f748;
              if (0x19 < bVar1) goto LAB_0011f80c;
              iVar5 = uVar13 - 1;
              iVar2 = uVar13 - 2;
              if (bVar1 == 0x16) {
                if ((int)uVar13 < 2) goto switchD_0011f83c_caseD_1f;
                puVar10 = local_200[iVar5];
                local_200[iVar5] = local_200[iVar2];
                local_200[iVar2] = puVar10;
              }
              else {
                if ((bVar1 != 0x17) || ((int)uVar13 < 3)) goto switchD_0011f83c_caseD_1f;
                puVar10 = local_200[iVar5];
            ...
            if (bVar1 == 0x12) {
              if (uVar13 == 0) goto switchD_0011f83c_caseD_1f;
              iVar5 = uVar13 - 1;
            }
            else {
              if (bVar1 < 0x12) {
              ...
              if ((bVar1 != 0x14) || ((int)uVar13 < 2)) goto switchD_0011f83c_caseD_1f;
              iVar5 = uVar13 - 2;
            }
            puVar10 = local_200[iVar5];
          }
...
switchD_0011f7bc_caseD_8:
            ...
            if (bVar1 != 0x19) goto switchD_0011f83c_caseD_1f;
            puVar10 = (ulonglong *)
          ...
          if (bVar1 == 0x23) {
            ...
            if (bVar1 == 0x94) {
              ...
              if (bVar1 != 0x20) goto switchD_0011f83c_caseD_1f;
    ...
    if (bVar1 < 0x50) {
      ...
      if (0x27 < bVar1) {
        if (bVar1 < 0x2f) {
          if (0x28 < bVar1) goto LAB_0011f80c;
          if (uVar13 == 0) goto switchD_0011f83c_caseD_1f;
          uVar13 = uVar13 - 1;
          param_1 = pbVar11 + 3;
      ...
      if ((bVar1 < 0x24) && (0x22 < bVar1)) goto LAB_0011f748;
LAB_0011f80c:
      if ((int)uVar13 < 2) goto switchD_0011f83c_caseD_1f;
      uVar3 = uVar13 - 2;
      ...
      if (bVar1 != 0x90) {
        if (bVar1 < 0x91) {
          ...
          if (bVar1 == 0x94) goto LAB_0011f748;
          if (0x94 < bVar1) {
            if (bVar1 != 0x96) {
              if (bVar1 == 0xf1) {
                bVar1 = pbVar11[1];
                uVar6 = FUN_0011ea1c((ulonglong)bVar1,param_3);
                param_1 = (byte *)FUN_0011e5ac((ulonglong)bVar1,uVar6,pbVar11 + 2,&local_208);
                puVar10 = local_208;
                goto LAB_0011f920;
              }
              goto switchD_0011f83c_caseD_1f;
          ...
          if (bVar1 != 0x92) goto switchD_0011f83c_caseD_1f;
...
LAB_0011f920:
  if (0x3f < uVar13) goto switchD_0011f83c_caseD_1f;
...
void FUN_0011f964(void *param_1,longlong *param_2)

{
  ...
  if ((((local_80 >> 0x3e & 1) == 0) || (local_49 == '\0')) && (local_2c8 == 0)) {
    FUN_0011e7b0(alStack960,*(undefined8 *)((longlong)param_1 + 0x310),auStack976);
  }
...
LAB_0011faac:
    ...
    lVar3 = FUN_0011f3b0(lVar3,lVar3 + local_3c8,alStack960,0);
  }
  *(longlong *)((longlong)param_1 + 0x310) = lVar3;
  ...
  do {
    ...
    case 3:
      ...
      lVar4 = FUN_0011f3b0(lVar4,lVar4 + local_3c8,alStack960,lVar3);
      break;
    case 4:
      lVar4 = lVar3 + *plVar7;
      goto LAB_0011fa9c;
...

{
  ...
  *(undefined8 *)((longlong)param_1 + 0x340) = 0x4000000000000000;
  iVar1 = FUN_0011ef8c(param_1,auStack1664);
  if (iVar1 == 0) {
    iVar1 = pthread_once((pthread_once_t *)&DAT_0014e3c4,FUN_0011e69c);
    if ((iVar1 != 0) && (DAT_0014e360 == '\0')) {
      FUN_0011e69c();
    }
    FUN_0011e7b0(param_1,param_2,auStack1672);
    local_58 = 0;
    local_40 = 1;
    local_50 = 0x1f;
    FUN_0011f964(param_1,auStack1664);
...
void FUN_0011fc4c(longlong param_1,longlong param_2)
...
undefined8 FUN_0011fc98(undefined8 *param_1,longlong param_2)

{
  ...
  do {
    iVar1 = FUN_0011ef8c(param_2,auStack1664);
    ...
    FUN_0011fc4c(param_2,auStack1664);
  } while( true );
}



ulonglong FUN_0011fd58(undefined8 *param_1,undefined8 param_2)

{
  ...
  uVar4 = param_1[3];
  while( true ) {
    uVar1 = FUN_0011ef8c(param_2,auStack1664);
    if ((uVar1 != 5) && (uVar1 != 0)) {
      return 2;
    }
    uVar5 = 10;
...

{
  ...
  iVar2 = FUN_0011ef8c(auStack2624,&local_680);
  lVar5 = 0;
...

{
  ...
  FUN_0011fb70(auStack3584,register0x00000008);
  memcpy(auStack2624,auStack3584,0x3c0);
  do {
    iVar1 = FUN_0011ef8c(auStack2624,auStack1664);
    if (iVar1 == 5) {
      return param_1;
    }
    if (iVar1 != 0) {
    ...
    if (local_30 != (code *)0x0) {
      ...
      if (iVar1 == 6) {
        ...
        memcpy(auStack2624,auStack3584,0x3c0);
        iVar1 = FUN_0011fc98(param_1,auStack2624);
        if (iVar1 == 7) {
          FUN_0011e844(auStack3584,auStack2624);
    ...
    FUN_0011fc4c(auStack2624,auStack1664);
  } while( true );
}
...

{
  ...
  FUN_0011fb70(auStack1920,register0x00000008);
  memcpy(auStack960,auStack1920,0x3c0);
  *(undefined8 *)(param_1 + 0x10) = param_2;
  *(undefined8 *)(param_1 + 0x18) = param_3;
  iVar1 = FUN_0011fd58(param_1,auStack960);
  if (iVar1 == 7) {
    FUN_0011e844(auStack1920,auStack960);
...

{
  ...
  if (*(longlong *)(param_1 + 0x10) == 0) {
    iVar1 = FUN_0011fc98(param_1,auStack960);
  }
  else {
    iVar1 = FUN_0011fd58(param_1,auStack960);
  }
...

{
  ...
  FUN_0011fb70(auStack2624,register0x00000008);
  while (((iVar1 = FUN_0011ef8c(auStack2624,auStack1664), iVar1 == 5 || (iVar1 == 0)) &&
...
void FUN_00120490(byte *param_1,ulonglong *param_2)
...
void FUN_001204b8(byte *param_1,ulonglong *param_2)
...
void FUN_00120514(undefined8 param_1,code *param_2,longlong param_3,ulonglong param_4,int param_5)
...
void FUN_001205d4(undefined8 param_1,undefined8 param_2,longlong param_3)

{
  ...
  while( true ) {
    ...
    FUN_00120514(param_1,param_2,lVar2,(ulonglong)uVar4,uVar5 & 0xffffffff);
  }
  lVar7 = 0;
  uVar4 = (int)uVar5 - 1;
  ...
  while (0 < (int)uVar4) {
    ...
    *(undefined8 *)(lVar1 + lVar7) = uVar3;
    uVar4 = uVar4 - 1;
    lVar7 = lVar7 + -8;
    FUN_00120514(param_1,param_2,lVar2,0,uVar5);
  }
  return;
}
...
undefined8 FUN_001206e8(byte param_1,longlong param_2)
...
undefined8 FUN_00120748(byte param_1,longlong param_2)
...
ulonglong ** FUN_001207a8(byte param_1,ulonglong **param_2,ulonglong **param_3,ulonglong **param_4)

{
  ...
  if (param_1 == 0x50) {
    ...
    case 0xc:
      ...
      break;
    case 1:
      ppuVar1 = (ulonglong **)FUN_00120490(param_3,&local_8);
      break;
    case 2:
      ppuVar1 = (ulonglong **)((longlong)param_3 + 2);
      local_8 = (ulonglong **)(ulonglong)*(ushort *)param_3;
    ...
    default:
      ...
      abort();
    case 9:
      ppuVar1 = (ulonglong **)FUN_001204b8(param_3,&local_8);
      break;
    case 10:
      ppuVar1 = (ulonglong **)((longlong)param_3 + 2);
      local_8 = (ulonglong **)(longlong)*(short *)param_3;
...
ulonglong FUN_00120898(longlong param_1,longlong param_2,longlong param_3)

{
  ...
  FUN_001207a8((ulonglong)(*(ushort *)(param_1 + 0x20) >> 3),uVar3,param_3 + 8,&local_8);
...
ulonglong FUN_00120928(longlong param_1)

{
  ...
  if (*(char *)(param_1 + 9) == 'z') {
    uVar4 = FUN_00120490(pcVar7,auStack16);
    lVar5 = FUN_001204b8(uVar4,auStack8);
    if (*(char *)(param_1 + 8) == '\x01') {
      lVar5 = lVar5 + 1;
    }
    else {
      lVar5 = FUN_00120490(lVar5,auStack16);
    }
    __s = (char *)(param_1 + 10);
    pbVar6 = (byte *)FUN_00120490(lVar5,auStack16);
    while (cVar1 = *__s, cVar1 != 'R') {
      if (cVar1 == 'P') {
        pbVar6 = (byte *)FUN_001207a8((ulonglong)((uint)*pbVar6 & 0x7f),0,pbVar6 + 1,auStack24);
      }
      else {
...
uint * FUN_00120a24(longlong param_1,uint *param_2,longlong param_3)

{
  ...
  uVar1 = FUN_001206e8(uVar7,param_1);
  lVar2 = 0;
  do {
    if (*param_2 == 0) {
      return (uint *)0;
    ...
    if (param_2[1] != 0) {
      ...
      if (((*(byte *)(param_1 + 0x20) >> 2 & 1) != 0) &&
        ...
        uVar3 = FUN_00120928(lVar6);
        uVar7 = uVar3 & 0xffffffff;
        uVar1 = FUN_001206e8(uVar3,param_1);
      }
      if ((uint)uVar7 == 0) {
        ...
        uVar4 = FUN_001207a8(uVar7 & 0xff,uVar1,param_2 + 2,&local_10);
        FUN_001207a8((ulonglong)((uint)uVar7 & 0xf),0,uVar4,&local_8);
        uVar3 = FUN_00120688(uVar7 & 0xff);
...
void FUN_00120b84(longlong param_1)

{
  FUN_00120928((param_1 + 4) - (longlong)*(int *)(param_1 + 4));
  return;
}



undefined8 FUN_00120b94(ulonglong *param_1,ulonglong param_2,ulonglong *param_3)
  ...
  if ((param_2 < 0x30) || (*(int *)(param_3 + 5) == 0)) {
    ...
    if ((param_1[4] == DAT_0013c138) && (param_1[5] == DAT_0014e3d0)) {
      ...
      while (puVar9 = puVar17, puVar9 != (ulonglong *)0x0) {
        if ((*puVar9 <= *param_3) && (*param_3 < puVar9[1])) {
          ...
          if (puVar9 != DAT_0014e3d8) {
            puVar15[5] = puVar9[5];
            *(ulonglong **)(puVar9 + 5) = DAT_0014e3d8;
            DAT_0014e3d8 = puVar9;
          }
          goto LAB_00120da0;
        }
    ...
    do {
      ...
      *(undefined8 **)(puVar10 + -1) = puVar10;
      puVar10 = puVar10 + 6;
    } while (puVar10 != (undefined8 *)0x14e590);
    DAT_0014e558 = 0;
...
LAB_00120cbc:
  ...
  if (param_2 >= 0x30) {
    if ((puVar15 != (ulonglong *)0x0) && (puVar11 != (ulonglong *)0x0)) {
      puVar15[5] = puVar11[5];
      *(ulonglong **)(puVar11 + 5) = DAT_0014e3d8;
      DAT_0014e3d8 = puVar11;
    }
    puVar11 = DAT_0014e3d8;
    DAT_0014e3d8[2] = uVar16;
...
LAB_00120da0:
  ...
  bVar3 = *(byte *)(lVar1 + 1);
  uVar6 = FUN_00120748((ulonglong)bVar3,param_3);
  uVar6 = FUN_001207a8((ulonglong)bVar3,uVar6,lVar1 + 4,&local_40);
  bVar3 = *(byte *)(lVar1 + 2);
  if ((bVar3 != 0xff) && (*(char *)(lVar1 + 3) == ';')) {
    uVar7 = FUN_00120748((ulonglong)bVar3,param_3);
    piVar13 = (int *)FUN_001207a8((ulonglong)bVar3,uVar7,uVar6,&local_38);
    if (local_38 == 0) {
      return 1;
    }
    if (((ulonglong)piVar13 & 3) == 0) {
      ...
      uVar12 = FUN_00120b84(uVar16);
      uVar8 = FUN_00120688(uVar12 & 0xff);
      FUN_001207a8((ulonglong)((uint)(uVar12 & 0xff) & 0xf),0,uVar16 + (uVar8 & 0xffffffff) + 8,
                   &local_30);
  ...
  local_30 = 0;
  local_18 = local_40;
  uVar16 = FUN_00120a24(&local_30,local_40,*param_3);
  param_3[4] = uVar16;
  if (uVar16 != 0) {
    uVar16 = FUN_00120b84();
    uVar6 = FUN_00120748(uVar16 & 0xff,param_3);
    FUN_001207a8(uVar16 & 0xff,uVar6,param_3[4] + 8,&local_38);
    param_3[3] = local_38;
  }
  return 1;
}
...
ulonglong FUN_00120fb4(undefined8 param_1,longlong param_2,longlong param_3)

{
  ...
  uVar3 = FUN_001206e8(uVar2 & 0xff,param_1);
  FUN_001207a8(uVar2 & 0xff,uVar3,param_2 + 8,&local_10);
  uVar2 = FUN_00120b84(param_3);
  uVar3 = FUN_001206e8(uVar2 & 0xff,param_1);
  FUN_001207a8(uVar2 & 0xff,uVar3,param_3 + 8,&local_8);
  uVar1 = -(uint)(local_10 < local_8);
  if (local_8 < local_10) {
    uVar1 = 1;
  }
...
longlong FUN_00121050(ulonglong *param_1,uint *param_2)
  ...
  do {
    ...
    if (param_2[1] != 0) {
      ...
      if (lVar6 != lVar3) {
        ...
        uVar9 = FUN_001206e8((ulonglong)(byte)uVar2,param_1);
      ...
      FUN_001207a8(uVar8 & 0xff,uVar9,param_2 + 2,&local_8);
      uVar4 = FUN_00120688(uVar8 & 0xff);
      uVar5 = 0xffffffffffffffff;
...
void FUN_001211b0(longlong param_1,longlong *param_2,uint *param_3)
  ...
  while (*param_3 != 0) {
    if (param_3[1] != 0) {
      ...
      if ((int)uVar7 == 0) {
        ...
        FUN_001207a8(uVar7 & 0xff,uVar1,param_3 + 2,&local_8);
        uVar4 = FUN_00120688(uVar7 & 0xff);
...
longlong FUN_001212e4(ulonglong *param_1,ulonglong param_2)

{
  ...
  if (*(uint *)(param_1 + 4) >> 0xb == 0) {
    if ((*(byte *)(param_1 + 4) >> 1 & 1) == 0) {
      uVar14 = FUN_00121050(param_1,param_1[3]);
      if (uVar14 != 0xffffffffffffffff) goto LAB_00121388;
LAB_00121348:
      param_1[4] = 0;
      *(undefined2 *)(param_1 + 4) = 0x7f8;
      ...
      while (*plVar10 != 0) {
        lVar8 = FUN_00121050(param_1);
        if (lVar8 == -1) goto LAB_00121348;
        uVar14 = uVar14 + lVar8;
        plVar10 = plVar10 + 1;
      }
LAB_00121388:
...
LAB_00121708:
      ...
      if ((*(byte *)(param_1 + 4) >> 2 & 1) == 0) {
        if ((*(ushort *)(param_1 + 4) & 0x7f8) == 0) {
          pcVar13 = (code *)&LAB_001204f8;
        }
        else {
          pcVar13 = FUN_00120898;
        }
      }
      else {
        pcVar13 = FUN_00120fb4;
      }
      if (local_8 == (void *)0x0) {
        FUN_001205d4(param_1,pcVar13,local_10);
      }
      else {
        puVar16 = local_10 + 2;
        uVar18 = local_10[1];
        uVar11 = 0;
        puVar12 = &DAT_0014e560;
        puVar19 = puVar16;
        while (uVar11 != uVar18) {
          while ((puVar12 != &DAT_0014e560 &&
        ...
        *(longlong *)((longlong)pvVar3 + 8) = lVar8;
        if (*(longlong *)((longlong)local_8 + 8) + local_10[1] != uVar14) goto LAB_00121708;
        FUN_001205d4(param_1,pcVar13);
        pvVar3 = local_8;
        puVar2 = local_10;
...
LAB_00121310:
  ...
  if ((bVar1 & 1) == 0) {
    if ((bVar1 >> 1 & 1) == 0) {
      uVar9 = FUN_00120a24(param_1,param_1[3],param_2);
      return uVar9;
    }
    plVar10 = (longlong *)param_1[3];
    while (*plVar10 != 0) {
      lVar8 = FUN_00120a24(param_1,*plVar10,param_2);
      if (lVar8 != 0) {
        return lVar8;
      }
      plVar10 = plVar10 + 1;
    ...
    if ((bVar1 >> 2 & 1) == 0) {
      if ((*(ushort *)(param_1 + 4) & 0x7f8) == 0) {
        ...
        uVar15 = param_1[3];
        uVar14 = 0;
        uVar9 = FUN_001206e8(uVar11,param_1);
        uVar18 = *(undefined8 *)(uVar15 + 8);
        while (uVar6 = uVar18, uVar14 < uVar6) {
          uVar18 = uVar6 + uVar14 >> 1;
          lVar8 = *(longlong *)(uVar15 + (uVar18 + 2) * 8);
          uVar7 = FUN_001207a8(uVar11,uVar9,lVar8 + 8,&local_18);
          FUN_001207a8((ulonglong)((uint)uVar11 & 0xf),0,uVar7,&local_10);
          if (local_18 <= param_2) {
      ...
      while (uVar15 = uVar11, uVar14 < uVar15) {
        ...
        uVar6 = FUN_00120b84(lVar8);
        uVar9 = FUN_001206e8(uVar6 & 0xff,param_1);
        uVar9 = FUN_001207a8(uVar6 & 0xff,uVar9,lVar8 + 8,&local_18);
        FUN_001207a8((ulonglong)((uint)uVar6 & 0xf),0,uVar9,&local_10);
        if (local_18 <= param_2) {
          if (param_2 < local_18 + (longlong)local_10) {
            return lVar8;
          }
...

{
  ...
  if ((param_1 != (int *)0x0) && (*param_1 != 0)) {
    ...
    *(undefined8 **)(param_2 + 5) = DAT_0014e598;
...

{
  ...
  do {
    puVar7 = DAT_0014e598;
    if (DAT_0014e598 == (ulonglong *)0x0) {
      local_10 = 0;
      break;
    }
    DAT_0014e598 = (ulonglong *)DAT_0014e598[5];
    local_10 = FUN_001212e4(puVar7,param_1);
    ppuVar3 = (ulonglong **)&DAT_0014e5a0;
    puVar6 = DAT_0014e5a0;
...
LAB_00121c0c:
  ...
  if (local_10 == 0) {
    ...
    local_10 = 0;
    local_30 = param_1;
    iVar2 = dl_iterate_phdr(FUN_00120b94,&local_30);
    if (iVar2 < 0) {
      return 0;
    }
    if (local_10 == 0) {
    ...
    *param_2 = puVar7[1];
    ...
    if ((bVar1 >> 2 & 1) != 0) {
      uVar4 = FUN_00120b84(local_10);
    }
    uVar5 = FUN_001206e8(uVar4 & 0xff,puVar7);
    FUN_001207a8(uVar4 & 0xff,uVar5,local_10 + 8,&local_30);
  }
  param_2[2] = local_30;
  return local_10;
}
